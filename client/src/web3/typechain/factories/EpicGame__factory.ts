...
import type { EpicGame, EpicGameInterface } from "../EpicGame";
...
export class EpicGame__factory {
  static readonly abi = _abi;
  static createInterface(): EpicGameInterface {
    return new utils.Interface(_abi) as EpicGameInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EpicGame {
    return new Contract(address, _abi, signerOrProvider) as EpicGame;
  }
}
